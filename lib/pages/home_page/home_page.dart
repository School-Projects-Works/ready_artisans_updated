          ...
          child: GNav(
            ...
            tabs: [
              ...
              if (user.userType.toLowerCase() == 'artisan' &&
                ...
                const GButton(icon: Icons.apps, text: 'Dashboard'),
              const GButton(icon: Icons.request_page, text: 'Request'),
              const GButton(icon: Icons.person, text: 'Profile'),
            ],
          ),
        ),
        body: getWidgets(_buildScreens(), ref.watch(homePageIndexProvider)),
      ),
    );
  }
