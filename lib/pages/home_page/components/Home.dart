                        ...
                        trailing: TextButton(
                          onPressed: () {
                            FlutterLocationPicker(
                              initZoom: 11,
                              userAgent: 'ReadyArtisans',
                              initPosition: LatLong(
                                data.latitude ?? 6.700071,
                              ...
                              onPicked: (pickedData) {
                                ...
                                ref
                                  ...
                                  district:
                                      pickedData.addressData['neighbourhood'] ??
                                      '',
            ...
            Expanded(
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return ArtisanCard(artisan: artisan, isRated: true);
                },
              ),
            ),
          if (!_focus.hasFocus)
                              ...
                              SizedBox(
                                ...
                                child: LayoutBuilder(
                                  builder: (context, constraints) {
                                    ...
                                    int length = ratedList.length > 10
                                        ? 10
                                        : ratedList.length;
                                    return ListTile(
                                      title: Text(
